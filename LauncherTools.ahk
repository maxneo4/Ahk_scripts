...
F4::
value := DynamicInputBox("box dinamica", {width: 200, vspace: 32, Margin: 10, controls: [{name: "flag", type: "CheckBox", state: "1"}, {name: "input field", value: "22", options: ""}, {name: "options", type: "DropDownList", state:"c", value: "a|b|c|d"},{name: "list", type: "ComboBox", state: "d", value: "o|c|f|d"},{name: "numero", type: "Slider", options: "Range1-10 ToolTip", state: "2"},{name:"server",type: "ComboBox", help:"C:\temporal\servers.txt"}, {name:"serverB",type: "ComboBox", help:"C:\temporal\servers.txt"}]})
if value = "Canceled"
	MsgBox, , value, %value%
Else
	{
